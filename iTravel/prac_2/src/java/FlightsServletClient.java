 ...
 */
public class FlightsServletClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int freeSeats = queryFree(idVuelo, date);
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FlightsServletClient</title>");
            ...
            out.println("<h1>");
            if(freeSeats>0)
                out.println("There are a total of: "+freeSeats+ " free seats"
             + " in the flight with id: " + idVuelo);
            else
    ...
    private int queryFree(int idVuelo, int date) {
