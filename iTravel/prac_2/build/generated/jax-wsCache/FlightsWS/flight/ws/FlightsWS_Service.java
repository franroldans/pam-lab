 ...
 * 
 */
@WebServiceClient(name = "FlightsWS", targetNamespace = "http://ws.flight/", wsdlLocation = "http://localhost:8080/FlightsWS/FlightsWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FLIGHTSWS_QNAME = new QName("http://ws.flight/", "FlightsWS");
    ...
    public FlightsWS getFlightsWSPort() {
        return super.getPort(new QName("http://ws.flight/", "FlightsWSPort"), FlightsWS.class);
    }
    ...
    public FlightsWS getFlightsWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.flight/", "FlightsWSPort"), FlightsWS.class, features);
    }
